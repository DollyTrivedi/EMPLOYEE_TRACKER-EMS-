...
include ("connection.php");
	...
	if (isset($_POST['add_task_post']))
	{
		...
		echo "<script>window.location='emp_project.php';</script>";
	}
              ...
              <form role="form" action="" method="post" autocomplete="off">
                <div class="form-horizontal">
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" value="<?php echo $sq[2]; ?>" placeholder="Task Title" id="task_title" name="task_title" list="expense" class="form-control" id="default" readonly>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label col-sm-5">Project Description</label>
                    <div class="col-sm-7">
                      <textarea name="task_description" id="task_description" placeholder="Text Deskcription" class="form-control" rows="5" cols="5" readonly><?php echo $sq[2]; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label col-sm-5">Start Date</label>
                    <div class="col-sm-7">
                      <input type="text" value="<?php echo $sq[3]; ?>" name="t_start_time" id="t_start_time" class="form-control" readonly>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label col-sm-5">End Date</label>
                    <div class="col-sm-7">
                      <input type="text" value="<?php echo $sq[4]; ?>" name="t_end_time" id="t_end_time" class="form-control" readonly>
                    </div>
                  </div>
                  <div class="form-group">
				  ...
				  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      ...
                      <select class="form-control" name="assign_to" id="aassign_to" readonly>
